...
//    testJsonTypeInfo5();
  ...
  private static void testJsonTypeInfo2() throws IOException {
    ...
    ObjectMapper mapper = new ObjectMapper();
    String json = mapper.writeValueAsString(a);
    // {"i":1,"object":{"@class":"com.security.bug.jackson.test.JsonTypeInfoTest$B","i":2},"aa":null}
    System.out.println(json);

    json = "{\"i\":1,\"c\":{\"@class\":\"com.security.bug.jackson.test.JsonTypeInfoTest$C\",\"i\":2}}";
    a = mapper.readValue(json, A2.class);
    System.out.println(a.getC().getClass().getName());

    json = "{\"i\":1,\"aa\":{\"@class\":\"com.security.bug.jackson.test.JsonTypeInfoTest$AA\",\"xx\":2}}";
    a = mapper.readValue(json, A2.class);
    System.out.println(a.getAa().getClass().getName());

    json = "{\"i\":1,\"c\":{\"@class\":\"com.security.bug.jackson.test.JsonTypeInfoTest$D\",\"i\":2}}";
    a = mapper.readValue(json, A2.class);
  ...
  private static void testJsonTypeInfo3() throws IOException {
    ...
    ObjectMapper mapper = new ObjectMapper();
    String json = mapper.writeValueAsString(a);
    // {"i":1,"object":{"@c":"com.security.bug.jackson.test.JsonTypeInfoTest$B","i":2},"aa":null}
    System.out.println(json);

    json = "{\"i\":1,\"c\":{\"@c\":\"com.security.bug.jackson.test.JsonTypeInfoTest$C\",\"i\":2}}";
    a = mapper.readValue(json, A3.class);
    System.out.println(a.getC().getClass().getName());

    json = "{\"i\":1,\"aa\":{\"@c\":\"com.security.bug.jackson.test.JsonTypeInfoTest$AA\",\"xx\":2}}";
    a = mapper.readValue(json, A3.class);
    System.out.println(a.getAa().getClass().getName());

    json = "{\"i\":1,\"c\":{\"@c\":\"com.security.bug.jackson.test.JsonTypeInfoTest$D\",\"i\":2}}";
    a = mapper.readValue(json, A3.class);
