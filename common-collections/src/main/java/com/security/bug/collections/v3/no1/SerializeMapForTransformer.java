/*
 * [业务问题]: Apache Commons Collections 3.1 TransformedMap 反序列化漏洞验证。
 * [实现逻辑]: 利用 TransformedMap 在 Map 的 value 发生变化时触发 Transformer 链的特性，结合 ChainedTransformer 和 InvokerTransformer 构造 Runtime.exec 命令执行。
 */
package com.security.bug.collections.v3.no1;
