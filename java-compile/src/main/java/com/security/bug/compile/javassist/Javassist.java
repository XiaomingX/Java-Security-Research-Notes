package com.security.bug.compile.javassist;
...
public class Javassist {
    ...
    public static void testNewInstance()
        ...
        CtClass ctClass = classPool.get("com.security.bug.compile.javassist.A");
    ...
    public static void testAddSuperClass()
        ...
        ClassPool classPool = ClassPool.getDefault();
        CtClass ctClass = classPool.get("com.security.bug.compile.javassist.A");
        CtClass ctClass2 = classPool.get("com.security.bug.compile.javassist.B");
    ...
    public static void testMakeClass()
        throws NotFoundException, IllegalAccessException, InstantiationException, CannotCompileException {
        ClassPool classPool = ClassPool.getDefault();
        CtClass ctClass = classPool.makeClass("com.security.bug.compile.javassist.C");
        Class c = ctClass.toClass();
        Object o = c.newInstance();
        System.out.println(Arrays.stream(c.getMethods()).map(method -> method.getName()).collect(
            Collectors.joining(" ")));
    ...
    public static void testModifyMethod()
        ...
        Class c = ctClass.toClass();
        Object o = c.newInstance();
        c.getDeclaredMethod("a", String.class).invoke(o, "test");
        System.out.println(Arrays.stream(c.getMethods()).map(method -> method.getName()).collect(
            Collectors.joining(" ")));
    }
    ...
    public static void testAddField()
        ...
        ClassPool classPool = ClassPool.getDefault();
        CtClass ctClass = classPool.makeClass("com.security.bug.compile.javassist.D");
        StringBuilder stringBuilder = new StringBuilder()
